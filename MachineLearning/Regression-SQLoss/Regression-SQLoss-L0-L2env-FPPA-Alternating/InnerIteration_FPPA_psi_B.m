function [v1, w1, InnerNum, TargetValue] = InnerIteration_FPPA_psi_B(const, EVALUATE_HERE, LabelTrain, uLast, vLast, wLast, paraAlgo, paraModel, InnerTOL, OutIterIndex)
