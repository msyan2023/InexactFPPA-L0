...
Implement Algorithms in the paper to solve the L0-SVM regression model. 

---- Regular stopping criteria for inner iteration (Algorithm 1 in the paper) ----
	
	In the file "Alternating_SQLoss_L0_L2env.m", make sure using 
	...
	Run "Main_Regression_SQLoss_L0_L2env.m"
