function [v1, w1, InnerNum, TargetValue] = InnerIteration_FPPA_psi_B_1stepInnerIteration(const, EVALUATE_HERE, uLast, vLast, wLast, paraAlgo, paraModel, Img_obs, InnerTOL,OutIterIndex)
